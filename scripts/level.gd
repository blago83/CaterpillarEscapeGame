...
@onready var hud_label: Label = $CanvasLayer/HUD/MarginContainer/HBoxContainer/InfoLabel

func _ready() -> void:
    $CanvasLayer/HUD/MarginContainer/HBoxContainer/RetryButton.pressed.connect(_on_retry_pressed)
    $CanvasLayer/HUD/MarginContainer/HBoxContainer/MenuButton.pressed.connect(_on_menu_pressed)
